...
/**
 * Servlet implementation class DeleteGeoJSONFile
 */
@WebServlet("/DeleteGeoJSONFile")
public class DeleteGeoJSONFile extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteGeoJSONFile() {
        super();
	...
	protected void process(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			returnJson = GEOController.deleteGEOJSONFile(inputJson);
		}catch(Exception e){
			e.printStackTrace();
